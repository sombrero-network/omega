...
public class AccountOptions implements GrapheneSerializable {
     ...
     * response. TODO: Implement all other details besides the key
     */
    public static class AccountOptionsDeserializer implements JsonDeserializer<AccountOptions> {
        
        @Override
        public AccountOptions deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
