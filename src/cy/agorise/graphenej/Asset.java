...
public class Asset extends GrapheneObject {
    ...
    /**
     * Enum type used to represent the possible types an asset can be classified
     * into.
     */
    public enum AssetType {
        CORE_ASSET, UIA, SMART_COIN, PREDICTION_MARKET
    }
     ...
     *            The asset precision.
     * @param issuer:
     *            Graphene object id of the issuer.
     */
    ...
    /**
     * Custom deserializer used to instantiate a simple version of the Asset
