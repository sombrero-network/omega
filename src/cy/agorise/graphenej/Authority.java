...
/**
 * Class used to represent the weighted set of keys and accounts that must
 * approve operations.
 *
 * {@see <a href=
 * "https://bitshares.org/doxygen/structgraphene_1_1chain_1_1authority.html">Authority</a>}
 */
public class Authority implements GrapheneSerializable {
     ...
     * @param keyAuths:
     *            Map of key to weights relationships. Can be null.
     * @param accountAuths:
     *            Map of account to weights relationships. Can be null.
     * @throws MalformedAddressException
     */
    public Authority(long weight_threshold, HashMap<PublicKey, Long> keyAuths,
            HashMap<UserAccount, Long> accountAuths) {
        this();
    ...
    public byte[] toBytes() {
        ...
        // If the authority is not empty of references, we serialize its
        // contents
    ...
    public boolean equals(Object obj) {
        ...
        return this.key_auths.equals(keyAuths) && this.account_auths.equals(accountAuths)
                && this.weight_threshold == authority.weight_threshold;
    }
    
    /**
     * Custom deserializer used while parsing the 'get_account_by_name' API call
     * response.
     *
     * This will deserialize an account authority in the form:
     *
     * { "weight_threshold": 1, "account_auths": [], "key_auths":
     * [["BTS6yoiaoC4p23n31AV4GnMy5QDh5yUQEUmU4PmNxRQPGg7jjPkBq",1]],
     * "address_auths": [] }
     */
