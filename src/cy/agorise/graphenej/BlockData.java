...
/**
 * This class encapsulates all block-related information needed in order to
...
public class BlockData implements ByteSerializable {
     ...
     * 
     * @param ref_block_num:
     *            Least significant 16 bits from the reference block number. If
     *            "relative_expiration" is zero, this field must be zero as
     *            well.
     * @param ref_block_prefix:
     *            The first non-block-number 32-bits of the reference block ID.
     *            Recall that block IDs have 32 bits of block number followed by
     *            the actual block hash, so this field should be set using the
     *            second 32 bits in the block_id_type
     * @param relative_expiration:
     *            Expiration time specified as a POSIX or
     ...
     * 
     * @param head_block_number:
     *            The last block number.
     * @param head_block_id:
     *            The last block apiId.
     * @param relative_expiration:
     *            The expiration time.
     */
    ...
    /**
     * Plain setter for the ref_block_num field, assuming its value is exactly
     * the one passed in the argument.
     * 
     * @param refBlockNum:
     *            The 'ref_block_num' field.
     */
    ...
    /**
     * Setter that receives the block number, and takes the 16 lower bits of it
     * to obtain the 'ref_block_num' value.
     * 
     * @param blockNumber:
     *            The block number.
     */
    ...
    /**
     * Plain setter fot the 'ref_block_prefix' field, assumint its value is
     * exactly the one passed in the argument.
     * 
    ...
    /**
     * Setter that receives the head block id, and turns it into the little
     * format required for the 'ref_block_prefix' field.
     * 
     * @param headBlockId:
     *            The head block id as obtained from the network updates.
     */
