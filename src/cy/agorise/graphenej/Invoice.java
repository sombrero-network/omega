...
/**
 * Class used to handle invoice generation, compression and QR-Code data
 * derivation, as detailed in <a href=
 * "http://docs.bitshares.eu/integration/merchants/merchant-protocol.html">this</>
 * link.
 * 
...
public class Invoice implements JsonSerializable {
    ...
    public Invoice(String to, String to_label, String memo, String currency, LineItem[] items, String note,
            String callback) {
        this.to = to;
