...
public class LimitOrder extends GrapheneObject implements ByteSerializable {
    ...
    /**
     * Custom deserializer for the LimitOrder class, used to deserialize a
     * json-formatted string in the following format:
     *
     * { "id": "1.7.2389233", "expiration": "2017-04-21T15:40:04", "seller":
     * "1.2.114363", "forSale": "10564959415", "sell_price": { "base": {
     * "amount": "10565237932", "asset_id": "1.3.0" }, "quote": { "amount":
     * 5803878, "asset_id": "1.3.121" } }, "deferredFee": 0 }
     */
    public static class LimitOrderDeserializer implements JsonDeserializer<LimitOrder> {
        
        @Override
        public LimitOrder deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
