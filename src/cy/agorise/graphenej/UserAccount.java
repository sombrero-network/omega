...
public class UserAccount extends GrapheneObject implements ByteSerializable, JsonSerializable {
     ...
     * 
     * @param id:
     *            The string representing the user account.
     */
    ...
    /**
     * Constructor that expects a user account withe the proper graphene object
     * id and an account name.
     * 
     * @param id:
     *            The string representing the user account.
     * @param name:
    ...
    /**
     * Deserializer used to build a UserAccount instance from the full
     * JSON-formatted response obtained by the 'get_objects' API call.
     */
    public static class UserAccountFullDeserializer implements JsonDeserializer<UserAccount> {
        
        @Override
        public UserAccount deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
            ...
            // Handling the deserialization and assignation of the membership
            // date, which internally
            ...
            userAccount.setLifetimeReferrerFeePercentage(
                    jsonAccount.get(KEY_LIFETIME_REFERRER_FEE_PERCENTAGE).getAsLong());
    ...
    /**
     * Custom deserializer used to deserialize user accounts provided as
     * response from the 'lookup_accounts' api call. This response contains
     * serialized user accounts in the form [[{id1},{name1}][{id1},{name1}]].
     *
     * For instance:
     * [["bilthon-1","1.2.139205"],["bilthon-2","1.2.139207"],["bilthon-2016","1.2.139262"]]
     *
     * So this class will pick up this data and turn it into a UserAccount
     * object.
     */
    ...
    /**
     * Custom deserializer used to deserialize user accounts as provided by the
     * response of the 'get_key_references' api call. This response contains
     * serialized user accounts in the form [["id1","id2"]]
     */
