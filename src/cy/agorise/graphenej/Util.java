...
public class Util {
     ...
     * 
     * @param s:
     *            String with hexadecimal numbers representing a byte array.
     ...
     * 
     * @param data:
     *            Arbitrary ascii-encoded string.
     ...
     * 
     * @param inputBytes
     *            Input bytes of the data to be compressed.
     * @param which
     *            Which subclass of the FinishableOutputStream to use.
    ...
    /**
     * Utility function that decompresses data that has been compressed using
     * the LZMA algorithm by the {@link Util#compress(byte[], int)} method.
     * 
     * @param inputBytes
     *            Compressed data.
     * @param which
     *            Which subclass if InputStream to use.
    ...
    public static byte[] decompress(byte[] inputBytes, int which) {
        ...
        try {
            ...
            try {
                ...
                byte[] header = Bytes.concat(properties, Util.revertBytes(dictSize),
                        Util.revertBytes(uncompressedSize));
    ...
    /**
     * Same operation as in the revertInteger function, but with an UnsignedLong
     * object as argument.
     * 
     * @param input
     *            An UnsignedLong class instance
     * @return The array of bytes that represent this value in the reverse
     *         format.
     */
    ...
    public static byte[] encryptAES(byte[] input, byte[] key) {
        try {
            ...
            return temp;
        } catch (NoSuchAlgorithmException | DataLengthException | IllegalStateException
     ...
     * 
     * @param input
     *            array of bytes to transform as a string
    ...
    /**
     * Converts a base value to its standard version, considering the precision
     * of the asset.
     *
     * By standard representation we mean here the value that is usually
     * presented to the user, and which already takes into account the precision
     * of the asset.
     *
     * For example, a base representation of the core token BTS would be 260000.
     * By taking into consideration the precision, the same value when converted
     * to the standard format will be 2.6 BTS.
     *
     * @param assetAmount:
     *            The asset amount instance.
     ...
     * 
     * @param value:
     *            The value in the standard format
     * @param precision:
