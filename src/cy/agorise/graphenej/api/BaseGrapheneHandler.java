...
/**
 * Base class that should be extended by any implementation of a specific
...
public abstract class BaseGrapheneHandler extends WebSocketAdapter {
    ...
    /**
     * The 'id' field of a message to the node. This is used in order to
     * multiplex different messages using the same websocket connection.
     *
     * For example:
     *
    ...
    /**
     * Constructor (The original constructor, should be replaced with the one
     * that receives NodeErrorListener instead of WitnessResponseListener)
     *
     * @param listener
     *            listener to be notified in if an error occurs
     */
     ...
     *
     * @param listener
     *            listener to be notified if an error occurs
     */
    ...
    public void handleCallbackError(WebSocket websocket, Throwable cause) throws Exception {
        ...
        // Should be replaced for mErrorListener (NodeErrorListener type) only
        // in the future
