...
public class GetAccountBalances extends BaseGrapheneHandler {
     ...
     *
     * @param userAccount
     *            account to get balances for
     * @param assets
     *            list of the assets to get balances of; if empty, get all
     *            assets account has a balance in
     * @param oneTime
     ...
     */
    public GetAccountBalances(UserAccount userAccount, List<Asset> assets, boolean oneTime,
    ...
    public void onTextFrame(WebSocket websocket, WebSocketFrame frame) throws Exception {
        ...
        WitnessResponse<List<AssetAmount>> witnessResponse = gsonBuilder.create().fromJson(response,
                WitnessResponseType);
