 ...
 *
 * The request returns the header of the referenced block, or null if no
    ...
    public void onTextFrame(WebSocket websocket, WebSocketFrame frame) throws Exception {
        ...
        if (baseResponse.error != null) {
            ...
            if (baseResponse.id == LOGIN_ID) {
                ...
                Type RelativeAccountHistoryResponse = new TypeToken<WitnessResponse<BlockHeader>>() {
                }.getType();
                WitnessResponse<BlockHeader> transfersResponse = gson.fromJson(response,
