 ...
 *
 * The request returns all accounts that refer to the key or account id in their
 * owner or active authorities.
 *
...
public class GetKeyReferences extends BaseGrapheneHandler {
    ...
    public void onTextFrame(WebSocket websocket, WebSocketFrame frame) throws Exception {
        ...
        Type GetAccountByAddressResponse = new TypeToken<WitnessResponse<List<List<UserAccount>>>>() {
        }.getType();
        builder.registerTypeAdapter(UserAccount.class, new UserAccount.UserAccountSimpleDeserializer());
        WitnessResponse<List<List<UserAccount>>> witnessResponse = builder.create().fromJson(response,
