 ...
 *
 * The response returns a list of objects retrieved, in the order they are
 * mentioned in ids
 *
...
public class GetObjects extends BaseGrapheneHandler {
     ...
     *
     * @param ids
     *            list of IDs of the objects to retrieve
     * @param oneTime
    ...
    public void onTextFrame(WebSocket websocket, WebSocketFrame frame) throws Exception {
        ...
        JsonArray resultArray = parser.parse(response).getAsJsonObject().get(WitnessResponse.KEY_RESULT)
                .getAsJsonArray();
        for (JsonElement element : resultArray) {
            ...
            case ASSET_BITASSET_DATA:
                ...
                WitnessResponse<List<BitAssetData>> witnessResponse = gsonBuilder.create().fromJson(response,
                        BitAssetDataType);
