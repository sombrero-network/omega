...
/**
 * Class used to encapsulate the communication sequence used to retrieve the
 * transaction history of a given user.
 */
public class GetRelativeAccountHistory extends BaseGrapheneHandler {
     ...
     *
     * @param userAccount
     *            The user account to be queried
     * @param stop
     ...
     */
    public GetRelativeAccountHistory(UserAccount userAccount, int stop, int limit, int start, boolean oneTime,
    ...
    /**
     * Constructor that uses the default values, and sets the limit to its
    ...
    /**
     * Constructor that takes all possible parameters for the query. Using this
     * constructor the WebSocket connection closes after the response.
     *
     * @param userAccount
     *            The user account to be queried
     * @param stop
    ...
    public void onTextFrame(WebSocket websocket, WebSocketFrame frame) throws Exception {
        ...
        if (baseResponse.error != null) {
            ...
            if (baseResponse.id == LOGIN_ID) {
                ...
                Type RelativeAccountHistoryResponse = new TypeToken<WitnessResponse<List<HistoricalTransfer>>>() {
                }.getType();
                ...
                WitnessResponse<List<HistoricalTransfer>> transfersResponse = gsonBuilder.create().fromJson(response,
                        RelativeAccountHistoryResponse);
    ...
    private void sendRelativeAccountHistoryRequest() {
        ...
        ApiCall getRelativeAccountHistoryCall = new ApiCall(apiId, RPC.CALL_GET_RELATIVE_ACCOUNT_HISTORY, params,
                RPC.VERSION, currentId);
        mWebsocket.sendText(getRelativeAccountHistoryCall.toJsonString());
    }
    
    /**
     * Updates the arguments and makes a new call to the
     * get_relative_account_history API.
     *
     * @param stop
     *            Sequence number of earliest operation
     * @param limit
