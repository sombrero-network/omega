...
public class GetRequiredFees extends BaseGrapheneHandler {
     ...
     *
     * @param operations
     *            list of operations that fee should be calculated
     * @param asset
     *            specify the asset of the operations
     * @param oneTime
     ...
     */
    public GetRequiredFees(List<BaseOperation> operations, Asset asset, boolean oneTime,
