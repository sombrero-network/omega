 ...
 *
 * Get recent trades for the market assetA:assetB for a time interval Note:
 * Currently, timezone offsets are not supported. The time must be UTC.
 *
 * The request returns the all trades of the passed pair of asset at a specific
 * time interval.
 *
...
public class GetTradeHistory extends BaseGrapheneHandler {
     ...
     */
    public GetTradeHistory(String a, String b, String toTime, String fromTime, int limit, boolean oneTime,
     ...
     *            notified about the success/failure of the operation.
     */
    public GetTradeHistory(String a, String b, String toTime, String fromTime, int limit,
            WitnessResponseListener listener) {
    ...
    public void onTextFrame(WebSocket websocket, WebSocketFrame frame) throws Exception {
        ...
        try {
            ...
            WitnessResponse<List<MarketTrade>> witnessResponse = builder.create().fromJson(response,
