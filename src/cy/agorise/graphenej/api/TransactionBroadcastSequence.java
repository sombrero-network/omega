...
public class TransactionBroadcastSequence extends BaseGrapheneHandler {
     ...
     */
    public TransactionBroadcastSequence(Transaction transaction, Asset feeAsset, boolean oneTime,
    ...
    public void onTextFrame(WebSocket websocket, WebSocketFrame frame) throws Exception {
        ...
        if (baseResponse.error != null) {
            ...
            if (baseResponse.id == LOGIN_ID) {
                ApiCall networkApiIdCall = new ApiCall(1, RPC.CALL_NETWORK_BROADCAST, emptyParams, RPC.VERSION,
                        currentId);
                ...
                ApiCall getDynamicParametersCall = new ApiCall(0, RPC.CALL_GET_DYNAMIC_GLOBAL_PROPERTIES, emptyParams,
                ...
                ApiCall getRequiredFees = new ApiCall(0, RPC.CALL_GET_REQUIRED_FEES, accountParams, RPC.VERSION,
                        currentId);
                ...
                ApiCall call = new ApiCall(broadcastApiId, RPC.CALL_BROADCAST_TRANSACTION, transactions, RPC.VERSION,
                        currentId);
