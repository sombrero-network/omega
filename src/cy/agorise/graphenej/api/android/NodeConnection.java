 ...
 * node hop support).
 *
 * This class is intended to be used as a central broker for all full node API
 * requests. It should be used as a singleton under an application.
 */
public class NodeConnection {
    ...
    /*
     * Get the instance of the NodeConnection which is intended to be used as a
     * Singleton.
     */
    ...
    /**
     * Add a WebSocket URL node that will be added to the list used at node hop
     * scheme.
     *
     * @param url:
     *            URL of the node
    ...
    /**
     * Add a list of WebSocket URL nodes that will be added to the current list
     * and be used at node hop scheme.
     *
     * @param urlList:
     *            List of URLs of the nodes
     */
     ...
     *
     * @param user
     *            user credential used for restricted requested that needed to
     *            be logged
     * @param password
     *            password credential used for restricted requested that needed
     *            to be logged
     * @param subscribe
     *            if the node should be subscribed to the node
     * @param errorListener
     *            a class implementing the WitnessResponseListener interface.
     *            This should be implemented by the party interested in being
     *            notified about the failure of the desired broadcast operation.
     */
     ...
     *
     * @param handler
     *            request handler to be added to the connection
