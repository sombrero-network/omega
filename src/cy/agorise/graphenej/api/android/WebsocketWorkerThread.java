...
public class WebsocketWorkerThread extends Thread {
     ...
     *            URL of the WebSocket
     * @param errorListener
     *            a class implementing the NodeErrorListener interface. This
     *            should be implemented by the party interested in being
     *            notified about the failure of the connection.
     */
    ...
    /**
     * Add a WebSocketListener to the thread that will run. This should be
     * implemented by the party interested in being notified about the response
     * value of a request.
     *
     * @param listener
     *            listener implemented to be notified when the socket get a
