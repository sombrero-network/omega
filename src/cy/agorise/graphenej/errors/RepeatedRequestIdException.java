...
/**
 * Thrown by the
 * {@link cy.agorise.graphenej.api.SubscriptionMessagesHub#addRequestHandler(BaseGrapheneHandler)}
 * whenever the user tries to register a new handler with a previously
 * registered id
 */
