...
/**
 * Interface to be implemented by any class that hosts a
 * SubscriptionResponseDeserializer and wants to expose an interface for its
 * management of its listeners.
 *
...
public interface SubscriptionHub {
     ...
     * 
     * @param listener:
     *            The SubscriptionListener to add.
     */
     ...
     * 
     * @param listener:
     *            The SubscriptionListener to remove.
     */
