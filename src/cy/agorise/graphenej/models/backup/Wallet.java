...
public class Wallet {
     ...
     * @param brainKey:
     *            The brain key to be used.
     * @param brainkeySequence:
     *            The brain key sequence.
     * @param chainId:
     *            The chain id
     * @param password:
     *            Password used to encrypt all sensitive data.
     */
    public Wallet(String name, String brainKey, int brainkeySequence, String chainId, String password) {
        ...
        try {
            ...
            this.password_pubkey = new Address(ECKey.fromPublicOnly(ECKey.fromPrivate(passwordHash).getPubKey()))
                    .toString();
        ...
        try {
            ...
            this.brainkey_pubkey = new Address(ECKey.fromPublicOnly(ECKey.fromPrivate(brainkeyHash).getPubKey()))
                    .toString();
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
    ...
    /**
     * Method that will return the decrypted version of the "encrypted_brainkey"
     * field.
     * 
     * @param password:
     *            Password used to encrypt the encryption key.
     ...
     * 
     * @param password:
     *            The password used to encrypt the encryption key.
