...
public class TransferOperation extends BaseOperation {
    ...
    public String toJsonString() {
        // TODO: Evaluate using simple Gson class to return a simple string
        // representation and drop the TransferSerializer class
    ...
    /**
     * Serializer used to convert this object into a {@link JsonElement}
     * instance
     */
    public static class TransferSerializer implements JsonSerializer<TransferOperation> {
        
        @Override
        public JsonElement serialize(TransferOperation transfer, Type type,
    ...
    public static class TransferDeserializer implements JsonDeserializer<TransferOperation> {
        ...
        @Override
        public TransferOperation deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
