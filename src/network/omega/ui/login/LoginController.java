...
//    private JFXPasswordField password;
    ...
    public void updateErrorMessage(String message,
                                   Boolean tooltipIsVisible, Boolean messageIsVisible, Boolean errorStyleTextFieldVisible){
...
//        do registration call to faucet with https://testnet.sombrero.network/ api call
//        get callback from server that registration went fine and save credentials into local file
//        login into witness wss:// with valid credentials saved into local file and load main app
//        in main view get and display username information by doing wss:// api call

//        IMPORTANT: If you forget your pass phrase and username you will be unable to access your account,
//         we cannot reset or restore your password! Make sure you memorize or write down your password or save
//          the locally stored file with those <link to the file on local OS>
        ...
        if (username.getText().toLowerCase().matches("[a-z0-9\\.\\-]+") && username.getText().length() >= 3) {
            ...
            try {
                ...
                nodeConnection.addRequestHandler(new LookupAccounts(username.getText().toLowerCase(),
                        50, true, new WitnessResponseListener() {
                    @Override
                    public void onSuccess(WitnessResponse response) {
                        ...
                        if(RegisterUsingFaucet.register(username.getText().toLowerCase())){
                            ...
                            //fade out of registration/login ui view and fade into password backup notification view
                            fadeOut();
