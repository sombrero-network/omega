...
public class MainController implements Initializable, BookReturnCallback {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            nodeConnection.addRequestHandler(new GetAccountByName(username.toLowerCase(),
                ...
                public void onSuccess(WitnessResponse response) {
                    ...
                    Platform.runLater(() -> {
                        testJsonContainer.setText("You just made a call to witness server with your user credentials\n" +
                                "using websocket secure protocol. The returned user id by the server was : " + user.id);
                    });
                }
    ...
    private void handleAboutMenu(ActionEvent event) {
        LibraryAssistantUtil.loadWindow(getClass().getResource("/network/omega/ui/about/about.fxml"), "About Omega Governance", null);
    }
