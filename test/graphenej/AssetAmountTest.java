...
public class AssetAmountTest {
    ...
    public void testSubtraction() {
        assertEquals(large.subtract(small).getAmount(),
                new AssetAmount(UnsignedLong.valueOf(LARGE_VALUE - SMALL_VALUE), testAsset).getAmount());
        assertEquals(small.subtract(large).getAmount(),
                new AssetAmount(UnsignedLong.valueOf(Math.abs(SMALL_VALUE - LARGE_VALUE)), testAsset).getAmount());
    }
    ...
    public void testMultiplication() {
        ...
        // Testing the multiplication of a number that would normally give an
        // overflow
