...
public class GetKeyReferencesTest extends BaseApiTest {
    ...
    private String[] publicKeys = new String[] { "BTS8DuGHXpHYedq7qhT65BEEdQPvLT8nxZ862Hf8NgvSZUMuwUFkn",
            ...
            public void onSuccess(WitnessResponse response) {
                ...
                for (List<UserAccount> accountList : accountListList) {
                    ...
                    if (accountList.size() > 1) {
                        System.out.println("Key with address: " + publicKeys[counter]
                                + " controls more than one role in account: " + accountList.get(0).getObjectId());
                    } else if (accountList.size() == 1) {
                        System.out.println("Key with address: " + publicKeys[counter]
                                + " controls just one role in account: " + accountList.get(0).getObjectId());
                    }
                    counter++;
                }
