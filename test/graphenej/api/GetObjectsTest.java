        ...
        try {
            ...
            mWebSocket.addListener(new GetObjects(ids, new WitnessResponseListener() {
                ...
                public void onSuccess(WitnessResponse response) {
                    ...
                    System.out.println(
                            "owner............: " + userAccount.getOwner().getKeyAuthList().get(0).getAddress());
                    System.out.println(
                            "active key.......: " + userAccount.getActive().getKeyAuthList().get(0).getAddress());
                    System.out.println(
                            "active account...: " + userAccount.getActive().getAccountAuthList().get(0).getObjectId());
