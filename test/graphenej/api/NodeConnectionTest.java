...
public class NodeConnectionTest {
    ...
    private String ACCOUNT_NAME = "constantin-z";
...
//        }
    ...
    public void testGetTradeHistoryRequest(){
        ...
        try{
            nodeConnection.addRequestHandler(new GetTradeHistory(asset_sold_id, asset_purchased_id, start, end, limit, true, new WitnessResponseListener(){
                @Override
                public void onSuccess(WitnessResponse response) {
